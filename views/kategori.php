...
$stmt->execute([$id]);
$kategori = $stmt->fetch();
$nama_kategori = $kategori ? $kategori['nama_kategori'] : 'Kategori Tidak Ditemukan';

// Ambil produk pada kategori ini beserta nama toko
$stmt = $pdo->prepare("
...
<head>
    <meta charset="UTF-8">
    <title>Kategori: <?= htmlspecialchars($nama_kategori) ?> - Marketplace Desa</title>
...
<body class="bg-black min-h-screen">
    ...
    <div class="max-w-6xl mx-auto px-4 py-12">
        <h1 class="text-3xl font-bold text-yellow-400 mb-10 text-center">Kategori: <?= htmlspecialchars($nama_kategori) ?></h1>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            <?php if ($produkList): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <div class="col-span-full text-center text-gray-400 py-8">Belum ada produk di kategori ini.</div>
            <?php endif; ?>
        </div>
