...
<head>
    <meta charset="UTF-8">
    <title>Dashboard Petugas Desa - Daftar Pengajuan Dana</title>
...
<body class="bg-gray-100">
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 mt-12 border border-green-600 rounded-xl bg-white shadow max-w-7xl mx-auto">
            <h2 class="text-2xl font-bold text-green-700 mb-6">Dashboard Petugas Desa - Daftar Pengajuan Dana</h2>
...
?>">
                                    ...
                                    <td class="px-4 py-2 space-x-1">
                                        ...
                                        <?php if ($row['status'] === 'Menunggu'): ?>
                                            ...
                                            <a href="controllers/proses_verifikasi.php?id=<?= $row['id'] ?>&aksi=tolak" class="inline-block bg-red-500 text-white px-2 py-1 rounded hover:bg-red-600 text-xs">Tolak</a>
                                        <?php endif; ?>
