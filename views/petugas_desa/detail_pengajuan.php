...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="p-4 sm:ml-64">
        <div class="max-w-4xl mx-auto bg-white rounded-xl shadow p-6 border border-green-600 mt-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">
                ...
                <div><strong>Status:</strong>
                    ...
                    <?= $data['status'] === 'Disetujui' ? 'bg-green-100 text-green-700' : ($data['status'] === 'Diproses' ? 'bg-yellow-100 text-yellow-700' :
                ...
                <div>
                    ...
                    <?php if ($data['file_bukti']): ?>
                        <a href="/marketplace/uploads/pengajuan/<?= $data['file_bukti'] ?>" target="_blank" class="text-blue-600 underline">Lihat Dokumentasi</a>
                    <?php else: ?>
            ...
            <div class="flex justify-between mt-8">
                <a href="index.php?page=daftar-pengajuan" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded">← Kembali</a>
